 ...
 * @author dinhgiang1
 */
public class Menu_LopHoc_BaiTap extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btntaobt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btntaobtActionPerformed(evt);
            }
        });
    ...
    private void btntaobtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntaobtActionPerformed
        // TODO add your handling code here:
        Form_TaoBaiTap tbt = new Form_TaoBaiTap();
        ...
        tbt.setVisible(true);
    }//GEN-LAST:event_btntaobtActionPerformed
    ...
    private void btnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxoaActionPerformed
        try {
            ...
            Logger.getLogger(Menu_LopHoc_BaiTap.class.getName()).log(Level.SEVERE, null, ex);
        }
        // Xóa bài tập:
        if (FLAG == 1) {
        try {
