 ...
 * @author dinhgiang1
 */
public class Form_ThemHocSinh extends javax.swing.JFrame {
     ...
     */
    public Form_ThemHocSinh() {
        initComponents();
        FLAGDEFAULT();
        load_cb();
    }
    public Form_ThemHocSinh(int FLAG, String MAHS, String IMGPATH) {
        initComponents();
        this.FLAG = FLAG;
        this.MAHS = MAHS;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_ThemHocSinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_ThemHocSinh().setVisible(true);
            }
        });
    }
